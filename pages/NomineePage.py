...
class NomineePage(ParentPage):
    ...
    def verify_nominee_detail_text(self):
        self.wait_for_element("nominee_details_text_xpath",self.nominee_details_text_xpath,condition="displayed",timeout=10)
    ...
    def mandatory_nominee_details_warning(self):
        ...
        self.wait_for_stability()
        nominee_relation_msg = self.get_message("nominee_relationship_warning_xpath",self.nominee_relationship_warning_xpath)
